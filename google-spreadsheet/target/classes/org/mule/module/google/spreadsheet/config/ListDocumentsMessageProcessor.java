...
/**
 * ListDocumentsMessageProcessor invokes the {@link org.mule.module.google.spreadsheet.GoogleSpreadSheetModule#listDocuments(java.lang.String, java.lang.String)} method in {@link GoogleSpreadSheetModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class ListDocumentsMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private String _secretTokenType;
    private static Logger logger = LoggerFactory.getLogger(ListDocumentsMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setSecretToken(Object value) {
     ...
     * @param value Value to set
     */
    public void setAccessToken(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("listDocuments"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            castedModuleObject = ((GoogleSpreadSheetModuleOAuth1Adapter) moduleObject);
        }
        if (castedModuleObject.getAccessToken() == null) {
            throw new MessagingException(CoreMessages.failedToInvoke("listDocuments"), event, new NotAuthorizedException("This connector has not yet been authorized, please authorize by calling \"authorize\"."));
        }
        try {
            String accessToken = castedModuleObject.getAccessToken();
            String accessTokenSecret = castedModuleObject.getAccessTokenSecret();
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = castedModuleObject.listDocuments(accessToken, accessTokenSecret);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("listDocuments"), event, e);
        }
    }
