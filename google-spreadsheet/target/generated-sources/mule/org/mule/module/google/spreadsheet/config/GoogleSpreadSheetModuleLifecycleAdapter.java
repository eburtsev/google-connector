...
/**
 * A <code>GoogleSpreadSheetModuleLifecycleAdapter</code> is a wrapper around {@link GoogleSpreadSheetModule } that adds lifecycle methods to the pojo.
 * 
 */
public class GoogleSpreadSheetModuleLifecycleAdapter
    extends GoogleSpreadSheetModuleCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(GoogleSpreadSheetModuleLifecycleAdapter.class);
